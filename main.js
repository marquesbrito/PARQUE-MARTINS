...
// CONFIGURAÇÃO DAS SENHAS - APENAS 3 CATEGORIAS SEM DIA
...
// Estrutura para armazenar senhas ocupadas
...
function atualizarValorTotal() {
    ...
    if (tipo === "NoDia" && boitv === "Sim") total += 50;
...
document.addEventListener("DOMContentLoaded", async function() {
    ...
    document.getElementById("enviar").addEventListener("click", async function() {
        ...
        // 🔒 Marca senha como ocupada LOCALMENTE
